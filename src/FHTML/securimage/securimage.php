...
class Securimage
{
     ...
     *
     */
    function Securimage($session_id = false)
    {
        $this->ttf_file = __DIR__ . DIRECTORY_SEPARATOR . 'elephant.ttf';
     ...
     */
    function show($width = null, $height = null, $length = null, $background_image = "")
    {
